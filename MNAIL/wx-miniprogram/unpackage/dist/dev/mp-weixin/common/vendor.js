...
function initRuntimeSocketService() {
  const hosts = "172.16.81.135,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_XGkHSC";
...
const pages = [
  ...
  {
    path: "pages/user/user-index/index",
    style: {
      navigationBarTitleText: "首页"
    }
  },
  {
    path: "pages/user/user-my/index",
    style: {
      navigationBarTitleText: "我的"
    }
  },
  {
    path: "pages/user/user-appoint/index",
    style: {
      navigationBarTitleText: "预约"
    }
  },
  {
    path: "pages/user/user-appointrecord/index",
    style: {
      navigationBarTitleText: "预约记录"
    }
  },
  {
    path: "pages/user/user-works/index",
    style: {
      navigationBarTitleText: "预约"
    }
  },
  {
    path: "pages/user/user-workdetail/index",
    style: {
      navigationBarTitleText: "作品详情"
    }
  },
  {
    path: "pages/user/user-information/index",
    style: {
      navigationBarTitleText: "预约"
    }
  },
  {
    path: "pages/staff/staff-index/index",
    style: {
      navigationBarTitleText: "工作台"
    }
  },
  {
    path: "pages/staff/staff-my/index",
    style: {
      navigationBarTitleText: "我的"
    }
  },
  {
    path: "pages/staff/staff-works/index",
    style: {
      navigationBarTitleText: "款式上传"
    }
  },
  {
    path: "pages/staff/staff-order/index",
    style: {
      navigationBarTitleText: "订单"
    }
  },
  {
    path: "pages/staff/staff-member/index",
    style: {
      navigationBarTitleText: "会员管理"
    }
  },
  {
    path: "pages/staff/staff-manage/index",
    style: {
      navigationBarTitleText: "员工管理"
    }
  },
  {
    path: "pages/staff/staff-information/index",
    style: {
...
var define_process_env_UNI_STAT_TITLE_JSON_default = { "pages/login/index": "登录", "pages/user/user-index/index": "首页", "pages/user/user-my/index": "我的", "pages/user/user-appoint/index": "预约", "pages/user/user-appointrecord/index": "预约记录", "pages/user/user-works/index": "预约", "pages/user/user-workdetail/index": "作品详情", "pages/user/user-information/index": "预约", "pages/staff/staff-index/index": "工作台", "pages/staff/staff-my/index": "我的", "pages/staff/staff-works/index": "款式上传", "pages/staff/staff-order/index": "订单", "pages/staff/staff-member/index": "会员管理", "pages/service/index": "服务项目", "pages/order/index": "订单", "pages/mine/index": "我的" };
